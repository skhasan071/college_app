          ...
          widget: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Education', style: TextStyle(color: Colors.grey)),
                Text(
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.pushReplacement(
                      ...
                      MaterialPageRoute(
                        builder:
                            (context) => CoursePreferencesPage(isFlow: false),
                      ),
                    );
                  },
                  child: Row(
        ...
        UiHelper.getCard(
          ...
          widget: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Text('Studying In', style: TextStyle(color: Colors.grey)),
                Text(
                  '12th - Passed',
                  style: TextStyle(fontWeight: FontWeight.bold),
                ),
                SizedBox(height: 12),
                Text('Passed In', style: TextStyle(color: Colors.grey)),
